...
| ID  | Current State                    | Trigger | MCP Condition                                                                                              | Next State                              | MCP Actions                                                                                                                                                                                                                                       | Response                                  |
| --- | -------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| P1  | PR*GATHERING_COMMENTS*[G/A]      | Accio   | Checks `.ai/task/comments.md` exists (exists)                                                              | PR*REVIEW_TASK_DRAFT*[G/A]              | Creates `.ai/task/review-task.md` with template                                                                                                                                                                                                   | [P1.md](responses/pr_transitions/P1.md)   |
| P1b | PR*GATHERING_COMMENTS*[G/A]      | Accio   | Checks `.ai/task/comments.md` exists (missing)                                                             | ERROR*COMMENTS_MISSING*[G/A]            | -                                                                                                                                                                                                                                                 | [P1b.md](responses/pr_transitions/P1b.md) |
| P2  | PR*REVIEW_TASK_DRAFT*[G/A]       | Accio   | Checks `.ai/task/review-task.md` exists (exists)                                                           | PR*APPLIED_PENDING_ARCHIVE*[G/A]        | -                                                                                                                                                                                                                                                 | [P2.md](responses/pr_transitions/P2.md)   |
| P2b | PR*REVIEW_TASK_DRAFT*[G/A]       | Accio   | Checks `.ai/task/review-task.md` exists (missing)                                                          | ERROR*REVIEW_TASK_MISSING*[G/A]         | -                                                                                                                                                                                                                                                 | [P2b.md](responses/pr_transitions/P2b.md) |
...
| P3b | PR*APPLIED_PENDING_ARCHIVE*[G/A] | Accio   | Checks `.ai/task/review-task-results.md` exists (missing)                                                  | ERROR*REVIEW_TASK_RESULTS_MISSING*[G/A] | -                                                                                                                                                                                                                                                 | [P3b.md](responses/pr_transitions/P3b.md) |
...
| A5b | ERROR*COMMENTS_MISSING*[G/A], ERROR*REVIEW_TASK_MISSING*[G/A]                                                  | Reparo  | Checks `.ai/task/comments.md` exists (doesn't exist); Checks `.ai/task/review-task.md` exists (doesn't exist) | PR*GATHERING_COMMENTS*[G/A]   | Creates `.ai/task/comments.md` file | [A5b.md](responses/reparo_transitions/A5b.md) |
...
| ID  | Current State                                                                                                                                                                                                                                                                                                                                                                            | Trigger | MCP Condition | Next State     | MCP Actions | Response                                    |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------- | -------------- | ----------- | ------------------------------------------- |
| F1  | Any state except ACHIEVE*TASK_EXECUTED, ACHIEVE_COMPLETE, ERROR_PLAN_MISSING, ERROR_CONTEXT_MISSING, ERROR_REVIEW_TASK_MISSING*[G/A], ERROR*REVIEW_TASK_RESULTS_MISSING*[G/A], PR*APPLIED_PENDING_ARCHIVE*[G/A], PR*CONFIRM_RESTART_COMMENTS*[G/A], PR*CONFIRM_RESTART_TASK*[G/A], PR*GATHERING_COMMENTS*[G/A], PR*REVIEW_TASK_DRAFT*[G/A], GATHER_NEEDS_CONTEXT, GATHER_EDITING_CONTEXT | Finite  | -             | GATHER_EDITING | -           | [F1.md](responses/finite_transitions/F1.md) |
